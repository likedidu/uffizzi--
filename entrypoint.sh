...
sed -i "s#UUID#$UUID#g;s#SecretPATH#${SecretPATH}#g;s#PASSWORD#${PASSWORD}#g;s#WG_PEER_PUBLIC_KEY#${WG_PEER_PUBLIC_KEY}#g;s#WG_PRIVATE_KEY#${WG_PRIVATE_KEY}#g config.json
